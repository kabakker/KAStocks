...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2023 at 06:41 PM
...
CREATE TABLE `sp500` (
  ...
  `Security` varchar(36) DEFAULT NULL,
  `GICS Sector` varchar(22) DEFAULT NULL,
  `GICS Sub-Industry` varchar(55) DEFAULT NULL,
  `Headquarters Location` varchar(43) DEFAULT NULL,
  `Date added` varchar(10) DEFAULT NULL,
  `CIK` varchar(7) DEFAULT NULL,
  `Founded` varchar(34) DEFAULT NULL
...
INSERT INTO `sp500` (`Symbol`, `Security`, `GICS Sector`, `GICS Sub-Industry`, `Headquarters Location`, `Date added`, `CIK`, `Founded`) VALUES
...
('ALLE', 'Allegion', 'Industrials', 'Building Products', 'New York City, New York', '2013-12-02', '1579241', '1908'),
('LNT', 'Alliant Energy', 'Utilities', 'Electric Utilities', 'Madison, Wisconsin', '2016-07-01', '352541', '1917'),
('ALL', 'Allstate', 'Financials', 'Property & Casualty Insurance', 'Northfield Township, Illinois', '1995-07-13', '899051', '1931'),
...
('AMZN', 'Amazon', 'Consumer Discretionary', 'Internet & Direct Marketing Retail', 'Seattle, Washington', '2005-11-18', '1018724', '1994'),
...
('AIG', 'American International Group', 'Financials', 'Property & Casualty Insurance', 'New York City, New York', '1980-03-31', '5272', '1919'),
...
('ABC', 'AmerisourceBergen', 'Health Care', 'Health Care Distributors', 'Conshohocken, Pennsylvania', '2001-08-30', '1140859', '1985'),
...
('ACGL', 'Arch Capital Group', 'Financials', 'Reinsurance', 'Hamilton, Bermuda', '2022-11-01', '947484', '1995'),
...
('AIZ', 'Assurant', 'Financials', 'Multi-line Insurance', 'New York City, New York', '2007-04-10', '1267238', '1892'),
...
('AZO', 'AutoZone', 'Consumer Discretionary', 'Specialty Stores', 'Memphis, Tennessee', '1997-01-02', '866787', '1979'),
('AVB', 'AvalonBay Communities', 'Real Estate', 'Residential REITs', 'Arlington, Virginia', '2007-01-10', '915912', '1978'),
('AVY', 'Avery Dennison', 'Materials', 'Paper & Plastic Packaging Products & Materials', 'Glendale, California', '1987-12-31', '8818', '1990'),
...
('BBWI', 'Bath & Body Works, Inc.', 'Consumer Discretionary', 'Specialty Stores', 'Columbus, Ohio', '1983-09-30', '701985', '1963'),
...
('BKNG', 'Booking Holdings', 'Consumer Discretionary', 'Internet & Direct Marketing Retail', 'Norwalk, Connecticut', '2009-11-06', '1075531', '1996'),
...
('AVGO', 'Broadcom Inc.', 'Information Technology', 'Semiconductors', 'San Jose, California', '2014-05-08', '1730168', '1961'),
...
('BG', 'Bunge Limited', 'Consumer Staples', 'Agricultural Products & Services', 'Chesterfield, Missouri', '2023-03-15', '1144519', '1818'),
...
('CPT', 'Camden Property Trust', 'Real Estate', 'Residential REITs', 'Houston, Texas', '2022-04-04', '906345', '1981'),
...
('CDAY', 'Ceridian', 'Information Technology', 'Application Software', 'Minneapolis, Minnesota', '2021-09-20', '1725057', '1992'),
...
('CI', 'Cigna', 'Health Care', 'Managed Health Care', 'Bloomfield, Connecticut', '1976-06-30', '1739940', '1982'),
...
('ED', 'Consolidated Edison', 'Utilities', 'Electric Utilities', 'New York City, New York', '1957-03-04', '1047862', '1823'),
('STZ', 'Constellation Brands', 'Consumer Staples', 'Distillers & Vintners', 'Victor, New York', '2005-07-01', '16918', '1945'),
('CEG', 'Constellation Energy', 'Utilities', 'Multi-Utilities', 'Baltimore, Maryland', '2022-02-02', '1868275', '1999'),
...
('CSGP', 'CoStar Group', 'Industrials', 'Research & Consulting Services', 'Washington, D.C.', '2022-09-19', '1057352', '1987'),
...
('CMI', 'Cummins', 'Industrials', 'Industrial Machinery & Supplies & Components', 'Columbus, Indiana', '1965-03-31', '26172', '1919'),
...
('DHR', 'Danaher Corporation', 'Health Care', 'Health Care Equipment', 'Washington, D.C.', '1998-11-18', '313616', '1969'),
('DRI', 'Darden Restaurants', 'Consumer Discretionary', 'Restaurants', 'Orlando, Florida', '1995-05-31', '940944', '1938'),
('DVA', 'DaVita Inc.', 'Health Care', 'Health Care Facilities', 'Denver, Colorado', '2008-07-31', '927066', '1979'),
...
('DISH', 'Dish Network', 'Communication Services', 'Cable & Satellite', 'Meridian, Colorado', '2017-03-13', '1001082', '1980'),
('DIS', 'Disney', 'Communication Services', 'Movies & Entertainment', 'Burbank, California', '1976-06-30', '1744489', '1923'),
...
('DOW', 'Dow Inc.', 'Materials', 'Commodity Chemicals', 'Midland, Michigan', '2019-04-01', '1751788', '2019'),
...
('DD', 'DuPont', 'Materials', 'Specialty Chemicals', 'Wilmington, Delaware', '2019-04-02', '1666700', '2017'),
('DXC', 'DXC Technology', 'Information Technology', 'IT Consulting & Other Services', 'Tysons Corner, Virginia', '2017-04-04', '1688568', '2017'),
('EMN', 'Eastman Chemical Company', 'Materials', 'Diversified Chemicals', 'Kingsport, Tennessee', '1994-01-01', '915389', '1920'),
('ETN', 'Eaton Corporation', 'Industrials', 'Electrical Components & Equipment', 'Dublin, Ireland', '1957-03-04', '1551182', '1911'),
('EBAY', 'eBay', 'Consumer Discretionary', 'Internet & Direct Marketing Retail', 'San Jose, California', '2002-07-22', '1065088', '1995'),
...
('ENPH', 'Enphase', 'Information Technology', 'Electronic Components', 'Fremont, California', '2021-01-07', '1463101', '2006'),
...
('EQR', 'Equity Residential', 'Real Estate', 'Residential REITs', 'Chicago, Illinois', '2001-12-03', '906107', '1969'),
('ESS', 'Essex Property Trust', 'Real Estate', 'Residential REITs', 'San Mateo, California', '2014-04-02', '920522', '1971'),
('EL', 'Estée Lauder Companies (The)', 'Consumer Staples', 'Personal Care Products', 'New York City, New York', '2006-01-05', '1001250', '1946'),
('ETSY', 'Etsy', 'Consumer Discretionary', 'Internet & Direct Marketing Retail', 'New York City, New York', '2020-09-21', '1370637', '2005'),
('RE', 'Everest Re', 'Financials', 'Reinsurance', 'Hamilton, Bermuda', '2017-06-19', '1095073', '1973'),
('EVRG', 'Evergy', 'Utilities', 'Electric Utilities', 'Kansas City, Missouri', '2018-06-05', '1711269', '1909'),
('ES', 'Eversource', 'Utilities', 'Multi-Utilities', 'Hartford, Connecticut', '2009', '72741', '1966'),
('EXC', 'Exelon', 'Utilities', 'Multi-Utilities', 'Chicago, Illinois', '1957-03-04', '1109357', '2000'),
('EXPE', 'Expedia Group', 'Consumer Discretionary', 'Internet & Direct Marketing Retail', 'Seattle, Washington', '2007-10-02', '1324424', '1996'),
...
('FAST', 'Fastenal', 'Industrials', 'Building Products', 'Winona, Minnesota', '2008-09-15', '815556', '1967'),
...
('FITB', 'Fifth Third Bank', 'Financials', 'Regional Banks', 'Cincinnati, Ohio', '1996-03-29', '35527', '1858'),
('FRC', 'First Republic Bank', 'Financials', 'Regional Banks', 'San Francisco, California', '2019-01-02', '1132979', '1985'),
...
('FIS', 'FIS', 'Financials', 'Transaction & Payment Processing Services', 'Jacksonville, Florida', '2006-11-10', '1136893', '1968'),
...
('FOXA', 'Fox Corporation (Class A)', 'Communication Services', 'Movies & Entertainment', 'New York City, New York', '2013-07-01', '1754301', '2019'),
('FOX', 'Fox Corporation (Class B)', 'Communication Services', 'Movies & Entertainment', 'New York City, New York', '2015-09-18', '1754301', '2019'),
('BEN', 'Franklin Templeton', 'Financials', 'Asset Management & Custody Banks', 'San Mateo, California', '1998-04-30', '38777', '1947'),
('FCX', 'Freeport-McMoRan', 'Materials', 'Copper', 'Phoenix, Arizona', '', '831259', '1912'),
...
('GEHC', 'GE HealthCare', 'Health Care', 'Health Care Technology', 'Chicago, Illinois', '2023-01-04', '1932393', '1994'),
('GEN', 'Gen Digital', 'Information Technology', 'Application Software', 'Tempe, Arizona', '2003-03-25', '849399', '1982'),
...
('GPC', 'Genuine Parts Company', 'Consumer Discretionary', 'Specialty Stores', 'Atlanta, Georgia', '1973-12-31', '40987', '1925'),
...
('HWM', 'Howmet Aerospace', 'Industrials', 'Aerospace & Defense', 'Pittsburgh, Pennsylvania', '1957-03-04', '4281', '2016'),
...
('HUM', 'Humana', 'Health Care', 'Managed Health Care', 'Louisville, Kentucky', '', '49071', '1961'),
...
('INVH', 'Invitation Homes', 'Real Estate', 'Residential REITs', 'Dallas, Texas', '2022-09-19', '1687229', '2012'),
...
('K', 'Kellogg\'s', 'Consumer Staples', 'Packaged Foods & Meats', 'Battle Creek, Michigan', '1989-09-11', '55067', '1906'),
...
('LHX', 'L3Harris', 'Industrials', 'Aerospace & Defense', 'Melbourne, Florida', '2008-09-22', '202058', '2019 (1895)'),
...
('LNC', 'Lincoln Financial', 'Financials', 'Multi-line Insurance', 'Radnor, Pennsylvania', '1976-06-30', '59558', '1905'),
...
('MAA', 'Mid-America Apartment Communities', 'Real Estate', 'Residential REITs', 'Memphis, Tennessee', '2016-12-02', '912595', '1977'),
...
('NWL', 'Newell Brands', 'Consumer Discretionary', 'Housewares & Specialties', 'Atlanta, Georgia', '1989-04-30', '814453', '1903'),
('NEM', 'Newmont', 'Materials', 'Gold', 'Denver, Colorado', '1969-06-30', '1164727', '1921'),
('NWSA', 'News Corp (Class A)', 'Communication Services', 'Publishing', 'New York City, New York', '2013-08-01', '1564708', '2013 (1980)'),
('NWS', 'News Corp (Class B)', 'Communication Services', 'Publishing', 'New York City, New York', '2015-09-18', '1564708', '2013 (1980)'),
...
('ORLY', 'O\'Reilly Auto Parts', 'Consumer Discretionary', 'Specialty Stores', 'Springfield, Missouri', '2009-03-27', '898173', '1957'),
...
('OTIS', 'Otis Worldwide', 'Industrials', 'Industrial Machinery & Supplies & Components', 'Farmington, Connecticut', '2020-04-03', '1781335', '2020 (1853)'),
...
('PARA', 'Paramount Global', 'Communication Services', 'Movies & Entertainment', 'New York City, New York', '1994-09-30', '813828', '2019 (1952)'),
...
('PAYC', 'Paycom', 'Information Technology', 'Application Software', 'Oklahoma City, Oklahoma', '2020-01-28', '1590955', '1998'),
...
('PKI', 'PerkinElmer', 'Health Care', 'Health Care Equipment', 'Waltham, Massachusetts', '1985-05-31', '31791', '1937'),
...
('RTX', 'Raytheon Technologies', 'Industrials', 'Aerospace & Defense', 'Waltham, Massachusetts', '1957-03-04', '101829', '1922'),
...
('ROK', 'Rockwell Automation', 'Industrials', 'Electrical Components & Equipment', 'Milwaukee, Wisconsin', '', '1024478', '1903'),
...
('SLB', 'Schlumberger', 'Energy', 'Oil & Gas Equipment & Services', 'Curaçao, Kingdom of the Netherlands', '1957-03-04', '87347', '1926'),
...
('SEE', 'Sealed Air', 'Materials', 'Paper & Plastic Packaging Products & Materials', 'Charlotte, North Carolina', '1957-03-04', '1012100', '1960'),
('SRE', 'Sempra Energy', 'Utilities', 'Multi-Utilities', 'San Diego, California', '2001?', '1032208', '1998'),
...
('SEDG', 'SolarEdge', 'Information Technology', 'Semiconductor Materials & Equipment', 'Herzliya, Israel', '2021-12-20', '1419612', '2006'),
...
('SNPS', 'Synopsys', 'Information Technology', 'Application Software', 'Mountain View, California', '2017-03-16', '883241', '1986'),
...
('TROW', 'T. Rowe Price', 'Financials', 'Asset Management & Custody Banks', 'Baltimore, Maryland', '', '1113169', '1937'),
...
('TXN', 'Texas Instruments', 'Information Technology', 'Semiconductors', 'Dallas, Texas', '', '97476', '1930'),
...
('TSCO', 'Tractor Supply', 'Consumer Discretionary', 'Specialty Stores', 'Brentwood, Tennessee', '2014-01-24', '916365', '1938'),
...
('USB', 'U.S. Bank', 'Financials', 'Diversified Banks', 'Minneapolis, Minnesota', '', '36104', '1968'),
('UDR', 'UDR, Inc.', 'Real Estate', 'Residential REITs', 'Highlands Ranch, Colorado', '2016-03-07', '74208', '1972'),
('ULTA', 'Ulta Beauty', 'Consumer Discretionary', 'Specialty Stores', 'Bolingbrook, Illinois', '2016-04-18', '1403568', '1990'),
...
('WBD', 'Warner Bros. Discovery', 'Communication Services', 'Broadcasting', 'New York City, New York', '2022-04-11', '1437107', '2022'),
('WM', 'Waste Management', 'Industrials', 'Environmental & Facilities Services', 'Houston, Texas', '', '823768', '1968'),
('WAT', 'Waters Corporation', 'Health Care', 'Health Care Distributors', 'Milford, Massachusetts', '2002-01-02', '1000697', '1958'),
...
('WRK', 'WestRock', 'Materials', 'Paper & Plastic Packaging Products & Materials', 'Atlanta, Georgia', '1957-03-04', '1732845', '2015'),
('WY', 'Weyerhaeuser', 'Real Estate', 'Timber REITs', 'Seattle, Washington', '', '106535', '1900'),
('WHR', 'Whirlpool Corporation', 'Consumer Discretionary', 'Household Appliances', 'Benton Harbor, Michigan', '', '106640', '1911'),
